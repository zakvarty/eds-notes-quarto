...
```{r, fig.align='center', fig.alt="Windows 95 logo on a background of white fluffy clouds. Text below reads: We're living in the 90s. Image is stylised to look like it is on a low resolution screen from the 90s.", out.width="100%", echo=FALSE}
...
```{r, warning=FALSE, message=FALSE, echo=FALSE, fig.align='center',fig.alt="Barplot showing an exponential-like increase in the volume of data created, captured, copied, and consumed worldwide in each year from 2010 to 2022."}
library(tidyverse)
...
```{r you-are-just-a-point-plot, fig.align='center', fig.alt="scatter plot of two predictors, x_1 and x_2. An arrow points to one observation, with the caption 'you are just a point in predictor space.'", out.width="100%", echo=FALSE}
...
```{r classification-plot, fig.align='center', fig.alt= "Two scatter plots illustrating classification and regression with two predictors. The outcome values are shown by colour for all but one point. This point is grey and represents the predictor values at a prediction point representing the reader.", out.width="100%", echo=FALSE}
