...
::: medium_right
```{r, fig.align="center", echo=FALSE, out.width="90%", fig.cap="Predicting pregnancy from search and purchase history.", fig.alt="An arrow connects a supemarket points card and search bar to a pregancy test, representing pregancy prediction."}
