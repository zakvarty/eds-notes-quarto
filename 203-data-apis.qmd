...
```{r geonames-register-screenshot}
#| out-width: 80%
#| fig-align: center
#| fig-alt: "Screenshot of the GeoNames login page. Example text has been added in the fields to create a new user account."
knitr::include_graphics(path = "images/203-data-apis/sign-up.png")
```


3. Activate the account (see activation email)

```{r geonames-confirmation-screenshot}
#| out-width: 80%
#| fig-align: center
#| fig-alt: "Screenshot of the GeoNames confirmation email, which gives a link to click in order to confirm the new account."
knitr::include_graphics(path = "images/203-data-apis/confirmation-email.png")
```
...
```{r bad-way-to-store-credentials}
#| echo: true
#| eval: false
...
```{r geonames-api-imperial-neighbours}
#| echo: true
#| eval: true
#| cache: true
...
```{r extract-mean-girls-response-content}
