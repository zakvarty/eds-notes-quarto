...
```
 ...
 here's weak evidence that suggests snake and skewer cases are most the readable.  We'll use a mixture of these, using snake case _between_ metadata items and skewer case _within_ them. This has a slight cost to legibility, in a trade-off against making computing on these file names easier. 
