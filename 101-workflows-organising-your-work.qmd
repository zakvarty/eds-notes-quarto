...
```{r 1-project-1-directory-image, echo = FALSE, out.width="80%"}
...
```{r protability-image, echo = FALSE, out.width="80%"}
...
```{r exciting-new-project-image, echo = FALSE, out.width="80%"}
...
```{r project-structure-image, echo = FALSE, out.width="80%"}
...
```{r readme-image, echo = FALSE, out.width="80%"}
...
```{r data-image, echo = FALSE, out.width="80%"}
...
```{r data-raw-image, echo = FALSE, out.width="80%"}
...
```{r data-derived-image, echo = FALSE, out.width="80%"}
...
```{r src-image, echo = FALSE, out.width="80%"}
...
```{r tests-image, echo = FALSE, out.width="80%"}
image_path <- "images/101-workflows-organising-your-work/directory-structure-drawings/directory-structure-drawing-12.png"
knitr::include_graphics(path = image_path)
``` 
...
```{r analyses-image, echo = FALSE, out.width="80%"}
...
```{r outputs-image, echo = FALSE, out.width="80%"}
...
```{r reports-image, echo = FALSE, out.width="80%"}
...
```{r make-image, echo = FALSE, out.width="80%"}
...
```{r project-structure-final-image, echo = FALSE, out.width="80%"}
